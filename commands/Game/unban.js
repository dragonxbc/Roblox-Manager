    ...
    async run(client, interaction){
        ...
        if(success){
            const Embed = new EmbedBuilder()
                ...
                .setDescription(`**Universe:** \`${universe.name}\` \n If this was a mistake and you would like to keep them banned, please use \`prefix@ban <userId> <reason>\``)
            ...
            return await interaction.editReply(`Failed to unban **${userName}**`)
    }
